...
$python_encrypted   = exec('python ' . __DIR__ . '/test.py encrypt "'.$secret.'" '.$iv);
...
$php_encrypted      = $cypher->encrypt($secret);
$python_secret   = exec('python ' . __DIR__ . '/test.py decrypt "'.$php_encrypted.'" '.$iv);
...
$python_secret   = exec('python ' . __DIR__ . '/test.py encrypt "'.$secret.'" '.$iv);
